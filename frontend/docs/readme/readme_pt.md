<p align="center">
  <img src="../../resources/salomoneui-banner-1.png" alt="SalomoneUI - Cowork with AI Agents" width="100%">
</p>

<p align="center">
  <img src="https://img.shields.io/github/v/release/iOfficeAI/SalomoneUI?style=flat-square&color=32CD32" alt="Version">
  &nbsp;
...
<p align="center">
  <a href="https://github.com/iOfficeAI/SalomoneUI/releases">
...
<p align="center">
  <a href="../../readme.md">English</a> | <a href="./readme_ch.md">简体中文</a> | <a href="./readme_tw.md">繁體中文</a> | <a href="./readme_jp.md">日本語</a> | <a href="./readme_ko.md">한국어</a> | <a href="./readme_es.md">Español</a> | <strong>Português</strong> | <a href="./readme_tr.md">Türkçe</a> | <a href="./readme_ru.md">Русский</a> | <a href="./readme_uk.md">Українська</a> | <a href="https://www.salomoneui.com" target="_blank">Site oficial</a>
</p>

<p align="center">
  <strong>💬 Comunidade:</strong> <a href="https://discord.gg/2QAwJn7Egx" target="_blank">Discord (English)</a> | <a href="../../resources/wx-10.png" target="_blank">微信 (中文群)</a> | <a href="https://twitter.com/SalomoneUI" target="_blank">Twitter</a>
</p>
...
[🤔 Por que escolher SalomoneUI?](#-por-que-escolher-salomoneui-sobre-claude-cowork) ·
...
**SalomoneUI é mais que um cliente de chat.** É uma plataforma Cowork onde os AI Agents trabalham com você no seu computador — lendo arquivos, escrevendo código, navegando na web e automatizando tarefas. Você pode ver tudo que o Agent faz e sempre está no controle.

|                                              | Clientes de chat AI tradicionais | **SalomoneUI (Cowork)**                                                                                                                        |
| :------------------------------------------- | :------------------------------- | :----------------------------------------------------------------------------------------------------------------------------------------- |
...
<p align="center">
  <img src="../../resources/offica-ai BANNER-function.png" alt="SalomoneUI Cowork Platform" width="800">
</p>
...
SalomoneUI vem com um motor de Agent AI completo. Diferente de ferramentas que exigem instalar CLI Agents separadamente, **SalomoneUI funciona no momento em que você o instala**.
...
Se você já usa Claude Code, Codex, Hermes Agent ou OpenClaw, SalomoneUI os detecta automaticamente e permite fazer Cowork com todos eles — junto com o Agent integrado.

**Agents compatíveis:** Agent integrado (configuração zero) • Claude Code • Codex • Qwen Code • Goose AI • OpenClaw • Augment Code • CodeBuddy • Kimi CLI • OpenCode • Factory Droid • GitHub Copilot • Qoder CLI • Mistral Vibe • Nanobot • Aion CLI (aionrs, o serviço backend em Rust incluído com o SalomoneUI) • Snow CLI • Kiro • Hermes Agent • Cursor Agent e mais
...
<p align="center">
  <img src="../../resources/SalomoneUI_team.gif" alt="Team Mode overview" width="800">
</p>

- **Execução paralela multi-agent** — Leader divide as tarefas em subtarefas e delega para agentes Teammate que executam em paralelo; cada Teammate usa seu próprio modelo via ACP (Agent Communication Protocol, a camada de coordenação multi-agent do SalomoneUI), Gemini ou Aionrs
...
Outros apps de AI te dão uma caixa de chat com sua chave API. **SalomoneUI te dá um Cowork Agent completo.**
...
As mesmas capacidades do Agent — leitura/escrita de arquivos, busca na web, geração de imagens, uso de ferramentas — independentemente do modelo que o alimenta. SalomoneUI suporta **20+ plataformas AI** incluindo serviços em nuvem e implantações locais.
...
SalomoneUI também suporta o serviço de gateway [NewAPI](https://github.com/QuantumNous/new-api) — um hub unificado de modelos AI que agrega e distribui vários LLMs. Alterne flexivelmente entre diferentes modelos na mesma interface para atender a vários requisitos de tarefas.
...
- **Habilidades de três camadas** — Habilidades integradas (incluídas com o SalomoneUI), habilidades personalizadas (suas próprias) e habilidades de Extension (contribuídas por extensões de terceiros); habilite/desabilite por conversa com o indicador de habilidades
...
SalomoneUI inclui **20 assistentes profissionais** com capacidades predefinidas, extensíveis através de habilidades personalizadas:
...
_Seu assistente AI 24/7 — acesse SalomoneUI de qualquer dispositivo, em qualquer lugar._
...
> **Configuração:** SalomoneUI Settings → WebUI Settings → Channel, configure o Bot Token.
...
> [Tutorial de acesso remoto à Internet](https://github.com/iOfficeAI/SalomoneUI/wiki/Remote-Internet-Access-Guide-Chinese)
...
- **Evitar suspensão** — O SalomoneUI previne automaticamente a suspensão do sistema enquanto as tarefas estão ativas e detecta acionamentos perdidos após o despertar
...
<p align="center">
  <img src="../../resources/salomoneui sort file 2.gif" alt="Smart File Management" width="800">
</p>
...
> [Guia de configuração do modelo de geração de imagens](https://github.com/iOfficeAI/SalomoneUI/wiki/SalomoneUI-Image-Generation-Tool-Model-Configuration-Guide)
...
## 🤔 Por que escolher SalomoneUI sobre Claude Cowork?
...
SalomoneUI é um **Desktop Multi-AI Agent gratuito e de código aberto**. Comparado ao Claude Cowork que só roda no macOS e está bloqueado ao Claude, SalomoneUI é sua versão aprimorada de modelo completo e multiplataforma.

| Dimensão           | Claude Cowork  | SalomoneUI                                              |
| :----------------- | :------------- | :-------------------------------------------------- |
...
R: <strong>Não.</strong> SalomoneUI tem um AI Agent integrado que funciona imediatamente após a instalação. Basta fazer login com Google ou inserir qualquer chave API. Se você também tiver ferramentas CLI como Claude Code ou Gemini CLI instaladas, SalomoneUI as detectará e integrará automaticamente para ainda mais capacidades.
</details>

<details>
<summary><strong>P: O que posso fazer com SalomoneUI?</strong></summary>
R: SalomoneUI é seu <strong>espaço de trabalho Cowork privado</strong>. O Agent integrado pode organizar pastas em lote, processar dados do Excel, gerar documentos, buscar na web e gerar imagens. Com o Modo Multi-Agent, você também pode aproveitar Claude Code, Codex e outros Agents CLI poderosos através da mesma interface.
</details>

<details>
<summary><strong>P: É gratuito?</strong></summary>
R: SalomoneUI é completamente gratuito e de código aberto. Você pode fazer login com Google para usar Gemini gratuitamente, ou usar chaves API de qualquer provedor que preferir.
</details>
...
## Veja como as pessoas usam SalomoneUI

<p align="center">
  <a href="https://www.youtube.com/watch?v=vWxE6VO9TKo" target="_blank">
    <img src="https://img.youtube.com/vi/vWxE6VO9TKo/maxresdefault.jpg" alt="Hermes + Salomone UI is Insane (FREE)!" width="400">
  </a>
  &nbsp;&nbsp;
  <a href="https://www.youtube.com/watch?v=RgSLdOhICZw" target="_blank">
    <img src="https://img.youtube.com/vi/RgSLdOhICZw/maxresdefault.jpg" alt="OpenClaw + Salomone UI is Insane (FREE!)" width="400">
  </a>
</p>
<p align="center">
  <em>Julian Goldie SEO — Hermes + Salomone UI is Insane (FREE!) · 27K views</em> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <em>Julian Goldie SEO — OpenClaw + Salomone UI is Insane (FREE!) · 11K views</em>
</p>
...
> **Fez um vídeo sobre SalomoneUI?** [Avise-nos no X](https://x.com/SalomoneUI) e vamos destacá-lo aqui!
...
brew install salomoneui
```

### Comece em 3 passos

1. **Instale** SalomoneUI
...
- [📖 Guia de instalação completo](https://github.com/iOfficeAI/SalomoneUI/wiki/Getting-Started) — Passos detalhados do download à configuração
- [⚙️ Guia de configuração LLM](https://github.com/iOfficeAI/SalomoneUI/wiki/LLM-Configuration) — Configuração de modelos AI multiplataforma
- [🤖 Configuração do modo Multi-Agent](https://github.com/iOfficeAI/SalomoneUI/wiki/ACP-Setup) — Integrar Agents AI de terminal
- [🔌 Configuração de ferramentas MCP](https://github.com/iOfficeAI/SalomoneUI/wiki/MCP-Configuration-Guide) — Configuração do servidor Model Context Protocol
- [🌐 Guia de configuração WebUI](https://github.com/iOfficeAI/SalomoneUI/wiki/WebUI-Configuration-Guide) — Tutorial completo de configuração e instalação do WebUI

**🎯 Casos de uso**

- [📁 Gerenciamento de arquivos](https://github.com/iOfficeAI/SalomoneUI/wiki/file-management) — Organização inteligente de arquivos
- [📊 Processamento de Excel](https://github.com/iOfficeAI/SalomoneUI/wiki/excel-processing) — Processamento de dados alimentado por AI
- [🎨 Geração de imagens](https://github.com/iOfficeAI/SalomoneUI/wiki/SalomoneUI-Image-Generation-Tool-Model-Configuration-Guide) — Criação de imagens AI
- [📚 Mais casos de uso](https://github.com/iOfficeAI/SalomoneUI/wiki/Use-Cases-Overview)

**❓ Suporte e ajuda**

- [❓ FAQ](https://github.com/iOfficeAI/SalomoneUI/wiki/FAQ) — Perguntas e solução de problemas
- [🔧 Tutoriais de configuração e uso](https://github.com/iOfficeAI/SalomoneUI/wiki/Configuration-Guides) — Documentação de configuração completa
...
<p align="center">
  <a href="https://x.com/SalomoneUI" target="_blank">
    <img src="../../resources/contactus-x.png" alt="Contact Us on X" width="600">
  </a>
</p>

- [GitHub Discussions](https://github.com/iOfficeAI/SalomoneUI/discussions) — compartilhe ideias e troque dicas
- [Reportar problemas](https://github.com/iOfficeAI/SalomoneUI/issues) — bugs e solicitações de recursos
- [Atualizações de lançamento](https://github.com/iOfficeAI/SalomoneUI/releases) — obtenha a última versão
...
<p align="center">
  <a href="https://github.com/iOfficeAI/SalomoneUI/graphs/contributors">
    <img src="https://contrib.rocks/image?repo=iOfficeAI/SalomoneUI&max=100" alt="Contributors" />
  </a>
</p>
...
<p align="center">
  <a href="https://www.star-history.com/#iOfficeAI/salomoneui&Date" target="_blank">
    <img src="https://api.star-history.com/svg?repos=iOfficeAI/salomoneui&type=Date" alt="Star History" width="600">
  </a>
</p>
...
[Reportar bug](https://github.com/iOfficeAI/SalomoneUI/issues) · [Solicitar recurso](https://github.com/iOfficeAI/SalomoneUI/issues)
