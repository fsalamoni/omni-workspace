...
<p align="center">
  <a href="../../readme.md">English</a> | <a href="./readme_ch.md">简体中文</a> | <a href="./readme_tw.md">繁體中文</a> | <a href="./readme_jp.md">日本語</a> | <a href="./readme_ko.md">한국어</a> | <a href="./readme_es.md">Español</a> | <a href="./readme_pt.md">Português</a> | <strong>Türkçe</strong> | <a href="./readme_ru.md">Русский</a> | <a href="./readme_uk.md">Українська</a> | <a href="https://www.salomoneui.com" target="_blank">Resmi Web Sitesi</a>
</p>

<p align="center">
  <strong>💬 Topluluk:</strong> <a href="https://discord.gg/2QAwJn7Egx" target="_blank">Discord (English)</a> | <a href="../../resources/wx-10.png" target="_blank">微信 (中文群)</a> | <a href="https://twitter.com/SalomoneUI" target="_blank">Twitter</a>
</p>
...
[🤔 Neden SalomoneUI'yi Seçmelisiniz?](#-neden-salomoneui-claude-cowork-yerine) ·
...
**SalomoneUI sadece bir sohbet istemcisi değil.** AI Agents'ın bilgisayarınızda sizinle çalıştığı bir Cowork platformudur — dosya okuma, kod yazma, web'de gezinme ve görevleri otomatikleştirme. Agent'ın yaptığı her şeyi görürsünüz ve her zaman kontrol sizdedir.

|                                        | Geleneksel AI Sohbet İstemcileri | **SalomoneUI (Cowork)**                                                                                                                   |
| :------------------------------------- | :------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------ |
...
SalomoneUI tam bir AI Agent motoru ile birlikte gelir. CLI Agent'ları ayrı olarak kurmanızı gerektiren araçların aksine, **SalomoneUI kurduğunuz anda çalışır**.
...
Zaten Claude Code, Codex, Hermes Agent veya OpenClaw kullanıyorsanız, SalomoneUI bunları otomatik olarak algılar ve hepsiyle Cowork yapmanıza izin verir — yerleşik Agent ile birlikte.

**Desteklenen Agents:** Yerleşik Agent (sıfır kurulum) • Claude Code • Codex • Qwen Code • Goose AI • OpenClaw • Augment Code • CodeBuddy • Kimi CLI • OpenCode • Factory Droid • GitHub Copilot • Qoder CLI • Mistral Vibe • Nanobot • Aion CLI (aionrs, SalomoneUI ile birlikte gelen Rust tabanlı arka uç servisi) • Snow CLI • Kiro • Hermes Agent • Cursor Agent ve daha fazlası
...
- **Paralel çoklu agent çalıştırma** — Leader görevleri alt görevlere bölerek paralel çalışan Teammate Agent'lara devreder; her Teammate ACP (Agent Communication Protocol, SalomoneUI'nin çoklu agent koordinasyon katmanı), Gemini veya Aionrs aracılığıyla kendi modelini kullanır
...
Diğer AI uygulamaları size API anahtarınızla bir sohbet kutusu verir. **SalomoneUI size tam bir Cowork Agent verir.**
...
Aynı Agent yetenekleri — dosya okuma/yazma, web arama, görüntü oluşturma, araç kullanımı — hangi modelin güç verdiğine bakılmaksızın. SalomoneUI bulut hizmetleri ve yerel dağıtımlar dahil **20+ AI platformunu** destekler.
...
SalomoneUI ayrıca [NewAPI](https://github.com/QuantumNous/new-api) ağ geçidi hizmetini destekler — çeşitli LLM'leri toplayan ve dağıtan birleşik bir AI model merkezi. Çeşitli görev gereksinimlerini karşılamak için aynı arayüzde farklı modeller arasında esnek bir şekilde geçiş yapın.
...
- **Üç katmanlı Beceriler** — Yerleşik beceriler (SalomoneUI ile birlikte gelen), özel beceriler (kendinizinkiler) ve Extension becerileri (üçüncü taraf uzantılar tarafından katkıda bulunulan); beceri göstergesi ile konuşma başına etkinleştirin/devre dışı bırakın
...
SalomoneUI önceden tanımlanmış yeteneklere sahip **20 profesyonel asistan** içerir, özel beceriler aracılığıyla genişletilebilir:
...
_7/24 AI asistanınız — SalomoneUI'ye herhangi bir cihazdan, her yerden erişin._
...
> **Kurulum:** SalomoneUI Ayarları → WebUI Ayarları → Kanal, Bot Token'ı yapılandırın.
...
> [Uzaktan İnternet Erişimi Öğreticisi](https://github.com/iOfficeAI/SalomoneUI/wiki/Remote-Internet-Access-Guide-Chinese)
...
- **Uyanık kal** — SalomoneUI görevler aktifken sistem uyku moduna geçmeyi otomatik olarak önler ve uyandıktan sonra kaçırılan tetikleyicileri algılar
...
> [Görüntü oluşturma modeli yapılandırma kılavuzu](https://github.com/iOfficeAI/SalomoneUI/wiki/SalomoneUI-Image-Generation-Tool-Model-Configuration-Guide)
...
## 🤔 Neden SalomoneUI, Claude Cowork Yerine?
...
SalomoneUI **ücretsiz ve açık kaynaklı bir Çoklu AI Agent Masaüstü** uygulamasıdır. Sadece macOS'ta çalışan ve Claude'ye kilitli Claude Cowork ile karşılaştırıldığında, SalomoneUI tam model, çapraz platform geliştirilmiş versiyonudur.

| Boyut           | Claude Cowork | SalomoneUI                                            |
| :-------------- | :------------ | :------------------------------------------------ |
...
C: <strong>Hayır.</strong> SalomoneUI kurulumdan hemen sonra çalışan yerleşik bir AI Agent'a sahiptir. Sadece Google ile giriş yapın veya herhangi bir API anahtarı girin. Ayrıca Claude Code veya Gemini CLI gibi CLI araçlarınız da kuruluysa, SalomoneUI bunları otomatik olarak algılayacak ve daha fazla yetenek için entegre edecektir.
</details>

<details>
<summary><strong>S: SalomoneUI ile ne yapabilirim?</strong></summary>
...
C: SalomoneUI tamamen ücretsiz ve açık kaynaklıdır. Gemini'yi ücretsiz kullanmak için Google ile giriş yapabilir veya tercih ettiğiniz herhangi bir sağlayıcıdan API anahtarları kullanabilirsiniz.
</details>
...
## İnsanların SalomoneUI'yi Nasıl Kullandığını Görün
...
> **SalomoneUI hakkında bir video yaptınız mı?** [X'te bize bildirin](https://x.com/SalomoneUI) ve burada öne çıkaralım!
...
- [📖 Tam Kurulum Kılavuzu](https://github.com/iOfficeAI/SalomoneUI/wiki/Getting-Started) — İndirmeden yapılandırmaya kadar detaylı adımlar
- [⚙️ LLM Yapılandırma Kılavuzu](https://github.com/iOfficeAI/SalomoneUI/wiki/LLM-Configuration) — Çoklu platform AI model yapılandırması
- [🤖 Çoklu Agent Modu Kurulumu](https://github.com/iOfficeAI/SalomoneUI/wiki/ACP-Setup) — Terminal AI Agent'larını entegre edin
- [🔌 MCP Araç Yapılandırması](https://github.com/iOfficeAI/SalomoneUI/wiki/MCP-Configuration-Guide) — Model Context Protocol sunucu kurulumu
- [🌐 WebUI Yapılandırma Kılavuzu](https://github.com/iOfficeAI/SalomoneUI/wiki/WebUI-Configuration-Guide) — Tam WebUI kurulum ve yapılandırma öğreticisi

**🎯 Kullanım Senaryoları**

- [📁 Dosya Yönetimi](https://github.com/iOfficeAI/SalomoneUI/wiki/file-management) — Akıllı dosya organizasyonu
- [📊 Excel İşleme](https://github.com/iOfficeAI/SalomoneUI/wiki/excel-processing) — AI destekli veri işleme
- [🎨 Görüntü Oluşturma](https://github.com/iOfficeAI/SalomoneUI/wiki/SalomoneUI-Image-Generation-Tool-Model-Configuration-Guide) — AI görüntü oluşturma
- [📚 Daha Fazla Kullanım Senaryosu](https://github.com/iOfficeAI/SalomoneUI/wiki/Use-Cases-Overview)

**❓ Destek ve Yardım**

- [❓ SSS](https://github.com/iOfficeAI/SalomoneUI/wiki/FAQ) — Sorular ve sorun giderme
- [🔧 Yapılandırma ve Kullanım Öğreticileri](https://github.com/iOfficeAI/SalomoneUI/wiki/Configuration-Guides) — Tam yapılandırma dokümantasyonu
...
- [GitHub Discussions](https://github.com/iOfficeAI/SalomoneUI/discussions) — fikirleri paylaşın ve ipuçları alışverişi yapın
- [Sorun Bildir](https://github.com/iOfficeAI/SalomoneUI/issues) — hatalar ve özellik istekleri
- [Sürüm Güncellemeleri](https://github.com/iOfficeAI/SalomoneUI/releases) — en son sürümü alın
...
[Hata Bildir](https://github.com/iOfficeAI/SalomoneUI/issues) · [Özellik İste](https://github.com/iOfficeAI/SalomoneUI/issues)
