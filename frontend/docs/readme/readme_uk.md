<p align="center">
  <img src="../../resources/salomoneui-banner-1.png" alt="SalomoneUI - Спільна робота з AI-агентами" width="100%">
</p>

<p align="center">
  <img src="https://img.shields.io/github/v/release/iOfficeAI/SalomoneUI?style=flat-square&color=32CD32" alt="Версія">
  &nbsp;
...
<p align="center">
  <a href="../../readme.md">English</a> | <a href="./readme_ch.md">简体中文</a> | <a href="./readme_tw.md">繁體中文</a> | <a href="./readme_jp.md">日本語</a> | <a href="./readme_ko.md">한국어</a> | <a href="./readme_es.md">Español</a> | <a href="./readme_pt.md">Português</a> | <a href="./readme_tr.md">Türkçe</a> | <a href="./readme_ru.md">Русский</a> | <strong>Українська</strong> | <a href="https://www.salomoneui.com" target="_blank">Офіційний сайт</a>
</p>

<p align="center">
  <strong>💬 Спільнота:</strong> <a href="https://discord.gg/2QAwJn7Egx" target="_blank">Discord (English)</a> | <a href="../../resources/wx-10.png" target="_blank">微信 (中文群)</a> | <a href="https://twitter.com/SalomoneUI" target="_blank">Twitter</a>
</p>
...
[🤔 Чому варто обрати SalomoneUI?](#-чому-варто-обрати-salomoneui-замість-claude-cowork) ·
...
**SalomoneUI — це більше, ніж просто чат-клієнт.** Це платформа для спільної роботи (Cowork), де AI-агенти працюють пліч-о-пліч із вами на вашому комп'ютері: читають файли, пишуть код, шукають в інтернеті та автоматизують завдання. Ви бачите все, що робить агент, і завжди зберігаєте контроль.

|                                    | Традиційні AI чат-клієнти | **SalomoneUI (Cowork)**                                                                                                        |
| :--------------------------------- | :------------------------ | :------------------------------------------------------------------------------------------------------------------------- |
...
SalomoneUI постачається з повноцінним рушієм AI-агентів. На відміну від інструментів, що вимагають окремого встановлення CLI-агентів, **SalomoneUI працює одразу після встановлення**.
...
Якщо ви вже використовуєте Claude Code, Codex, Hermes Agent або OpenClaw, SalomoneUI автоматично виявить їх і дозволить працювати з усіма ними разом із вбудованим агентом.

**Підтримувані агенти:** Вбудований агент • Claude Code • Codex • Qwen Code • Goose AI • OpenClaw • Augment Code • CodeBuddy • Kimi CLI • OpenCode • Factory Droid • GitHub Copilot • Qoder CLI • Mistral Vibe • Nanobot • Aion CLI (aionrs, Rust-бекенд-сервіс у складі SalomoneUI) • Snow CLI • Kiro • Hermes Agent • Cursor Agent та інші
...
- **Паралельне виконання кількох агентів** — Leader ділить завдання на підзадачі і делегує паралельно працюючим Teammate-агентам; кожен Teammate використовує свою модель через ACP (Agent Communication Protocol, шар координації мульти-агентності SalomoneUI), Gemini або Aionrs
...
Інші додатки дають лише вікно чату. **SalomoneUI дає повноцінного агента для спільної роботи.**
...
Ті ж самі можливості — читання/запис файлів, веб-пошук, генерація зображень — незалежно від того, яка модель використовується. SalomoneUI підтримує **20+ AI-платформ**.
...
- **Трирівневі навички** — вбудовані навички (поставляються з SalomoneUI), власні навички (ваші особисті) та Extension-навички (від сторонніх розширень); вмикайте/вимикайте для кожної розмови з індикатором навичок
...
**Навички**: навички з трьох джерел — вбудовані (поставляються з SalomoneUI), власні (ваші особисті) та Extension (через Extension SDK). Вбудовані: `pptx`, `docx`, `pdf`, `xlsx`, `mermaid` та інші.
...
- **Режим без сну** — SalomoneUI автоматично запобігає переходу системи у сплячий режим, поки активні завдання, та визначає пропущені тригери після пробудження
...
<p align="center">
  <img src="../../resources/salomoneui sort file 2.gif" alt="Керування файлами" width="800">
</p>

---

## 🤔 Чому варто обрати SalomoneUI замість Claude Cowork?

SalomoneUI — це **безкоштовний Multi-AI Agent десктоп**. На відміну від Claude Cowork, який працює лише на macOS і обмежений лише Claude, SalomoneUI — це версія з підтримкою всіх моделей та платформ.
...
- [GitHub Discussions](https://github.com/iOfficeAI/SalomoneUI/discussions) — діліться ідеями
- [Повідомити про проблему](https://github.com/iOfficeAI/SalomoneUI/issues) — баги та запити функцій
