...
[Why Choose SalomoneUI?](#-why-choose-salomoneui-over-claude-cowork) ·
...
**SalomoneUI is more than a chat client.** It's a Cowork platform where AI agents work alongside you on your computer — reading files, writing code, browsing the web, and automating tasks. You see everything the agent does, and you're always in control.

|                                 | Traditional AI Chat Clients | **SalomoneUI (Cowork)**                                                                                                           |
| :------------------------------ | :-------------------------- | :---------------------------------------------------------------------------------------------------------------------------- |
...
SalomoneUI ships with a complete AI agent engine. Unlike tools that require you to install CLI agents separately, **SalomoneUI works the moment you install it**.
...
If you already use Claude Code, Codex, Hermes Agent, or OpenClaw, SalomoneUI auto-detects them and lets you Cowork with all of them — alongside the built-in agent.

**Supported Agents:** Built-in Agent (zero setup) • Claude Code • Codex • Qwen Code • Goose AI • OpenClaw • Augment Code • CodeBuddy • Kimi CLI • OpenCode • Factory Droid • GitHub Copilot • Qoder CLI • Mistral Vibe • Nanobot • Aion CLI (aionrs, the Rust-based backend service bundled with SalomoneUI) • Snow CLI • Kiro • Hermes Agent • Cursor Agent and more
...
- **Parallel multi-agent execution** — Leader breaks tasks into subtasks and delegates to Teammate agents running in parallel; each Teammate uses its own model via ACP (Agent Communication Protocol, SalomoneUI's multi-agent coordination layer), Gemini, or Aionrs
...
Other AI apps give you a chatbox with your API key. **SalomoneUI gives you a full Cowork agent.**
...
Same agent capabilities — file read/write, web search, image generation, tool use — regardless of which model powers it. SalomoneUI supports **20+ AI platforms** including cloud services and local deployments.
...
SalomoneUI also supports [NewAPI](https://github.com/QuantumNous/new-api) gateway service — a unified AI model hub that aggregates and distributes various LLMs. Flexibly switch between different models in the same interface to meet various task requirements.
...
- **Three-tier Skills** — Builtin skills (shipped with SalomoneUI), custom skills (your own), and Extension skills (contributed by third-party extensions); enable/disable per conversation with the skill indicator
...
SalomoneUI supports three skill layers: **built-in** skills (shipped with the app), **custom** skills (user-defined), and **extension** skills (loaded from the Extension SDK).
...
SalomoneUI includes **20 professional assistants** with predefined capabilities, extendable through custom skills:
...
**Custom Skills**: Create skills in the `skills/` directory, enable/disable skills for assistants to extend AI capabilities. Skills come from three sources: builtin (shipped with SalomoneUI), custom (your own), and Extension (contributed via the Extension SDK). Built-in skills include `pptx`, `docx`, `pdf`, `xlsx`, `mermaid`, and more.
...
_Your 24/7 AI assistant — access SalomoneUI from any device, anywhere._
...
> **Setup:** SalomoneUI Settings → WebUI Settings → Channel, configure the Bot Token.
...
> [Remote Internet Access Tutorial](https://github.com/iOfficeAI/SalomoneUI/wiki/Remote-Internet-Access-Guide-Chinese)
...
- **Keep-awake** — SalomoneUI automatically prevents system sleep while tasks are active, and detects missed triggers after wake
...
> [Image generation model configuration guide](https://github.com/iOfficeAI/SalomoneUI/wiki/SalomoneUI-Image-Generation-Tool-Model-Configuration-Guide)
...
## 🤔 Why Choose SalomoneUI Over Claude Cowork?
...
SalomoneUI is a **free and open-source Multi-AI Agent Desktop**. Compared to Claude Cowork which only runs on macOS and is locked to Claude, SalomoneUI is its full-model, cross-platform enhanced version.

| Dimension     | Claude Cowork | SalomoneUI                                                            |
| :------------ | :------------ | :---------------------------------------------------------------- |
...
A: <strong>No.</strong> SalomoneUI has a built-in AI agent that works immediately after installation. Just sign in with Google or enter any API key. If you also have CLI tools like Claude Code or Gemini CLI installed, SalomoneUI will auto-detect and integrate them for even more capabilities.
</details>

<details>
<summary><strong>Q: What can I do with SalomoneUI?</strong></summary>
A: SalomoneUI is your <strong>private Cowork workspace</strong>. The built-in agent can batch organize folders, process Excel data, generate documents, search the web, and generate images. With Multi-Agent Mode, you can also leverage Claude Code, Codex, and other powerful CLI agents through the same interface.
</details>

<details>
<summary><strong>Q: Is it free?</strong></summary>
A: SalomoneUI is completely free and open source. You can sign in with Google to use Gemini for free, or use API keys from any provider you prefer.
</details>

<details>
<summary><strong>Q: Can I run SalomoneUI on a server (headless)?</strong></summary>
A: Yes — SalomoneUI WebUI mode runs as a standalone HTTP server. See the WebUI section above for setup instructions.
</details>
...
> **Made a video about SalomoneUI?** [Let us know on X](https://x.com/SalomoneUI) and we'll feature it here!
...
- [📖 Complete Installation Guide](https://github.com/iOfficeAI/SalomoneUI/wiki/Getting-Started) — Detailed steps from download to configuration
- [⚙️ LLM Configuration Guide](https://github.com/iOfficeAI/SalomoneUI/wiki/LLM-Configuration) — Multi-platform AI model configuration
- [🤖 Multi-Agent Mode Setup](https://github.com/iOfficeAI/SalomoneUI/wiki/ACP-Setup) — Integrate terminal AI agents
- [🔌 MCP Tool Configuration](https://github.com/iOfficeAI/SalomoneUI/wiki/MCP-Configuration-Guide) — Model Context Protocol server setup
- [🌐 WebUI Configuration Guide](https://github.com/iOfficeAI/SalomoneUI/wiki/WebUI-Configuration-Guide) — Complete WebUI setup and configuration tutorial

**🎯 Use Cases**

- [📁 File Management](https://github.com/iOfficeAI/SalomoneUI/wiki/file-management) — Smart file organization
- [📊 Excel Processing](https://github.com/iOfficeAI/SalomoneUI/wiki/excel-processing) — AI-driven data processing
- [🎨 Image Generation](https://github.com/iOfficeAI/SalomoneUI/wiki/SalomoneUI-Image-Generation-Tool-Model-Configuration-Guide) — AI image creation
- [📚 More Use Cases](https://github.com/iOfficeAI/SalomoneUI/wiki/Use-Cases-Overview)

**❓ Support & Help**

- [❓ FAQ](https://github.com/iOfficeAI/SalomoneUI/wiki/FAQ) — Questions and troubleshooting
- [🔧 Configuration & Usage Tutorials](https://github.com/iOfficeAI/SalomoneUI/wiki/Configuration-Guides) — Complete configuration documentation
...
- [GitHub Discussions](https://github.com/iOfficeAI/SalomoneUI/discussions) — share ideas and exchange tips
- [Report Issues](https://github.com/iOfficeAI/SalomoneUI/issues) — bugs and feature requests
- [Release Updates](https://github.com/iOfficeAI/SalomoneUI/releases) — get the latest version
...
[Report Bug](https://github.com/iOfficeAI/SalomoneUI/issues) · [Request Feature](https://github.com/iOfficeAI/SalomoneUI/issues)
