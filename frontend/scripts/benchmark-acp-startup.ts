...
function getLogFilePath(): string {
  ...
  // Dev mode uses "SalomoneUI-Dev", production uses "SalomoneUI"
  const devPath = path.join(os.homedir(), 'Library', 'Logs', 'SalomoneUI-Dev', `${today}.log`);
  const prodPath = path.join(os.homedir(), 'Library', 'Logs', 'SalomoneUI', `${today}.log`);
