...
function printTerminalReport(report: BenchReport): void {
  console.log('\n  ╔══════════════════════════════════════════════════════════════╗');
  console.log('  ║              SalomoneUI Performance Benchmark Report            ║');
  console.log('  ╚══════════════════════════════════════════════════════════════╝');
...
<head>
<meta charset="utf-8">
<title>SalomoneUI Benchmark Report - ${report.timestamp}</title>
<style>
...
<body>
<h1>SalomoneUI Performance Benchmark Report</h1>
<div class="meta">
