  ...
  try {
    ...
    return createSuccessResponse({
      ...
      text: [
        '🔗 <b>Device Pairing</b>',
        '',
        'Please approve this pairing request in the SalomoneUI app:',
        '',
        `<code>${code}</code>`,
        '',
  ...
  try {
    ...
    return createSuccessResponse({
      ...
      text: [
        ...
        `⏱ Valid for: ${expiresInMinutes} minutes`,
        '',
        'Please approve this pairing request in SalomoneUI settings.',
      ].join('\n'),
      parseMode: 'HTML',
      replyMarkup: getPairingCodeMarkup(platform, code),
    });
  ...
  if (pendingRequest) {
    ...
    return createSuccessResponse({
      ...
      text: [
        ...
        '',
        'Please approve the pairing request in SalomoneUI settings.',
      ].join('\n'),
      parseMode: 'HTML',
...
export const handlePairingHelp: ActionHandler = async (context) => {
  ...
  return createSuccessResponse({
    ...
    text: [
      ...
      '',
      '<b>What is pairing?</b>',
      `Pairing links your ${platformName} account with the local SalomoneUI application.`,
      'You need to pair before using the AI assistant.',
      '',
      '<b>Pairing steps:</b>',
      '1. Get pairing code (send any message)',
      '2. Open SalomoneUI app',
