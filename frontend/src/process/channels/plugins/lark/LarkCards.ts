...
export function createMainMenuCard(): LarkCard {
  return {
    ...
    header: {
      title: { tag: 'plain_text', content: 'SalomoneUI Assistant' },
      template: 'blue',
    },
    elements: [
      {
    ...
    elements: [
      {
        ...
        content: [
          '**What is pairing?**',
          'Pairing links your Lark/Feishu account with the local SalomoneUI application.',
...
export function createHelpCard(): LarkCard {
  return {
    config: { wide_screen_mode: true },
    header: {
      title: { tag: 'plain_text', content: '❓ SalomoneUI Assistant Help' },
      template: 'turquoise',
    },
    elements: [
      {
        tag: 'markdown',
        content: [
          'A remote assistant to interact with SalomoneUI via Lark.',
          '',
          '**Common Actions:**',
