...
База данных дизайна интегрирована в проект SalomoneUI по адресу `assistant/ui-ux-pro-max/data/`. Используйте скрипт поиска для нахождения релевантной дизайн-информации:
