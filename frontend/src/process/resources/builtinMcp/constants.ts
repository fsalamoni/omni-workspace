...
export const BUILTIN_IMAGE_GEN_NAME = 'salomoneui-image-generation';
export const BUILTIN_IMAGE_GEN_LEGACY_NAMES = ['SalomoneUI Image Generation', BUILTIN_IMAGE_GEN_ID] as const;
