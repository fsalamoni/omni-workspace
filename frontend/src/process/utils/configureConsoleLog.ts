 ...
 *   - macOS:   ~/Library/Logs/SalomoneUI/YYYY-MM-DD.log
 *   - Windows: %USERPROFILE%\AppData\Roaming\SalomoneUI\logs\YYYY-MM-DD.log
 *   - Linux:   ~/.config/SalomoneUI/logs/YYYY-MM-DD.log
 *
