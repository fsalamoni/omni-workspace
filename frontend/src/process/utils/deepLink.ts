...
export const PROTOCOL_SCHEME = 'salomoneui';

/**
 * Parse an salomoneui:// URL into action and params.
 * Supports two formats:
 *   1. salomoneui://add-provider?baseUrl=xxx&apiKey=xxx
 *   2. salomoneui://provider/add?v=1&data=<base64 JSON>  (one-api / new-api style)
 */
