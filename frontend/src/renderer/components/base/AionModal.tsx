...
const AionModal: React.FC<AionModalProps> = ({
  ...
  return (
    <Modal
      ...
      footer={null}
      onCancel={onCancel}
      className={`salomoneui-modal ${className}`}
      style={finalStyle}
      getPopupContainer={() => document.body}
    >
      <div className='salomoneui-modal-wrapper' style={{ borderRadius: borderRadiusVal }}>
        {renderHeader()}
        <div className='salomoneui-modal-body-content' style={bodyInlineStyle}>
          {children}
        </div>
        {renderFooter()}
      </div>
