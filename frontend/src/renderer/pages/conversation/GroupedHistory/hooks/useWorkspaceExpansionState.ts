...
export const WORKSPACE_EXPANSION_STORAGE_KEY = 'salomoneui_workspace_expansion';
export const WORKSPACE_EXPANSION_EVENT = 'salomoneui:workspace-expansion-changed';
