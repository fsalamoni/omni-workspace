export const WORKSPACE_TOGGLE_EVENT = 'salomoneui-workspace-toggle';
export const WORKSPACE_STATE_EVENT = 'salomoneui-workspace-state';
export const WORKSPACE_HAS_FILES_EVENT = 'salomoneui-workspace-has-files';
