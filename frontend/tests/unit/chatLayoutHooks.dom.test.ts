...
vi.mock('@/renderer/utils/workspace/workspaceEvents', () => ({
  WORKSPACE_TOGGLE_EVENT: 'salomoneui-workspace-toggle',
  WORKSPACE_STATE_EVENT: 'salomoneui-workspace-state',
  WORKSPACE_HAS_FILES_EVENT: 'salomoneui-workspace-has-files',
...
describe('useWorkspaceCollapse', () => {
  const STORAGE_KEY = 'salomoneui_workspace_panel_collapsed';
