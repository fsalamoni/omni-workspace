...
describe('NodePlatformServices.paths', () => {
  ...
  it('getDataDir falls back to homedir/.salomoneui-server', async () => {
    const { NodePlatformServices } = await import('../../../src/common/platform/NodePlatformServices');
    expect(new NodePlatformServices().paths.getDataDir()).toBe(path.join(os.homedir(), '.salomoneui-server'));
  });
  ...
  it('getLogsDir falls back to homedir/.salomoneui-server/logs', async () => {
    const { NodePlatformServices } = await import('../../../src/common/platform/NodePlatformServices');
    expect(new NodePlatformServices().paths.getLogsDir()).toBe(path.join(os.homedir(), '.salomoneui-server', 'logs'));
  });
